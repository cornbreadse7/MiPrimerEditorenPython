...
def main():
    ...
    layout = [
        ...
        [sg.Button('Abrir', size=(10, 1)), sg.Button('Negativo', size=(10, 1)), sg.Button('Logaritmica', size=(10, 1)),
         sg.Button('Cosenoidal', size=(10, 1)), sg.Button('Guardar', size=(10, 1)), sg.Button('Exit', size=(10, 1))]
    ]
